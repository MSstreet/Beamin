    ...
    public ShoppingBasketRes addShoppingBasket(ShoppingBasketDto shoppingBasketDto) throws BaseException {
        try {
            if (shoppingBasketDao.checkShoppingBasket(shoppingBasketDto) == 1) {
                ...
                ShoppingBasketRes shoppingBasket = shoppingBasketDao.getShoppingBasket(shoppingBasketDto.getUserId());

                GetMenuRes getMenuRes1 = menuProvider.getMenuByMenuId(shoppingBasket.getMenuId());
                ...
                if (!(getMenuRes1.getRestaurantId().equals(getMenuRes.getRestaurantId()))) {
                    ...
                    if (shoppingBasket.getMenuId().equals(shoppingBasketDto.getMenuId())) {

                        ShoppingBasketRes shoppingBasket1 = shoppingBasketDao.getShoppingBasketByMenuID(shoppingBasket.getMenuId());


                        shoppingBasketDao.modifyShoppingBasket(shoppingBasketDto,shoppingBasket1.getCount());
                    } else {
